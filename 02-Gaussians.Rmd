...
Consider a displaced Gaussian unitary and an arbitrary displaced quadratic operator 
\begin{equation} 
...
\begin{align}
    \varphi (E_x(\theta)) 
    &= \varphi\circ\psi(e^{-i \theta \gamma_1/2}) = \varphi \begin{pmatrix}
        0 & i\theta/2 & \cdots \\ 
        i\theta/2 \\ 
        \vdots && \ddots \\ 
    \end{pmatrix} = \begin{pmatrix}
...
\end{align}
Let $U_Z$ denote controlled-$Z$ on the first and second qubits, then 
\[ 
    |GHZ_4\ra = U_2U_ZU_1|0\ra^{\otimes 4}
\] 
:::